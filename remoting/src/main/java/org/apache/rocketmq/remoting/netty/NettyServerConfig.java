...
public class NettyServerConfig implements Cloneable {
    ...
    * */
    ...
    /*解析请求并转发给特定的业务线程池
    *   IO 线程池线程个数，主要是 NameServer、Broker 端解析请求、返回相应的线程个数。。这类线程主要是处理网络请求的，解析请
    * 求包， 然后转发到各个业务线程池完成具体的业务操作，然后将结果再返回调用方
    * */
     ...
     */
    private boolean useEpollNativeSelector = false; //是否启用Epoll IO模型，Linux环境建议开启
