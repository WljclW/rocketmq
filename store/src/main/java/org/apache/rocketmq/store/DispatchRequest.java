...
public class DispatchRequest {
    ...
    private final long tagsCode; //消息过滤的tag哈希码
    private final long storeTimestamp; //消息存储时间戳
    private final long consumeQueueOffset; //消息在consumeQueue中的偏移量
    private final String keys; //消息的索引key，可以有多个(以 空格 分开多个)
    private final boolean success; //是否成功解析到完整消息
    private final String uniqKey; //消息唯一键

    private final int sysFlag; //消息的系统标志
    private final long preparedTransactionOffset; //事务消息的预提交偏移量？？？
    private final Map<String, String> propertiesMap; //消息的属性
